...
// Example: go build -ldflags "-X github.com/mrmxf/clog-mrmxf/semver.SemVerJSON='...'"
//
...
func LinkerPath() string {
	...
	// For "github.com/mrmxf/clog-mrmxf/semver", we want "github.com/mrmxf/clog-mrmxf"
	...
	return "github.com/mrmxf/clog-mrmxf/semver.SemVerJSON"
}
...
func getPackagePath() string {
	...
	return "github.com/mrmxf/clog-mrmxf/semver"
}
